    ...
    <div id="centeredDiv">
      ...
      <div id="element">
        ...
        <input
          ...
          v-bind:defaultValue="this.props.event.title"
        />
      </div>
      <div id="element">
        ...
        <input
          ...
          v-bind:defaultValue="this.props.event.title.description"
        />
      </div>
      <div id="element">
      ...
      <div id="element">
        ...
        <input
          ...
          v-bind:defaultValue="this.props.event.date"
        />
      </div>
      <div id="element">
      ...
      <div type="button" @click="handleSubmit()">
        <router-link id="modifBtn" to="/home">Submit Changes</router-link>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleChange(event) {
      axios
        .put(`http://localhost:3000/api/event/modif/${event.id}`, {
          title: this.title,
